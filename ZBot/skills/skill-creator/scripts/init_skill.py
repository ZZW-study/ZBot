...
For example, start with task-based and add workflow for complex operations.
...
**Appropriate for:** Python scripts, shell scripts, or executable code that
performs automation, data processing, or specific operations.

**Note:** Scripts may be executed without loading into context, but can still be
read by Codex for patching or environment adjustments.
...
comprehensive guides, or detailed information Codex should reference while working.
